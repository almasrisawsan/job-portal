    ...
    <div className="flex flex-col gap-8 my-10">
      {jobs.length > 0 ? (
        jobs.map((job) => (
          <div
            key={job.id}
            className="flex sm:flex-row flex-col justify-between items-center gap-6 shadow-[0px_2px_4px_0px_#00000026] p-6 border border-light dark:border-gray-700 rounded-[10px] w-full"
          >
            {/* Left: Logo + Info */}
            ...
            {/* Right: Button */}
            <div className="flex justify-start sm:justify-end w-full sm:w-auto text-white">
